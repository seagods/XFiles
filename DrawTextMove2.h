void DrawTextMove2(bool draw_the_box)
{
    ...
    if(!draw_the_box){
     ...
     //  Image size is 676 wide 434 hide
      ...
      glBindTexture(GL_TEXTURE_2D,gl_Texture[17]);
...
//              k=0 is bottom left arrow, k=24 top right
                ...
                if(mousedown && firstmousedown && arrows[k]){
                   ...
                   if(k==22)shift4+=10;  if(k==23)shift4-=10;   //all x axis in out

                   if(k==16)shift2+=10;  if(k==17)shift2-=10;   //all y numbers left/right
                   if(k==18)shift5+=10;  if(k==19)shift5-=10;   //all lower y numbers in/out

                   if(k==12)shift6+=10;  if(k==13)shift6-=10;   //all z numbers radially
                   if(k==14)shift3-=10;  if(k==15)shift3+=10;  //all z numbers up/down

                   if(k==8)shift7+=10;  if(k==9)shift7-=10;      //xtext left right
                   if(k==10)shift8-=10;  if(k==11)shift8+=10;      // in out

                   if(k==4)shift9-=10;  if(k==5)shift9+=10;    //y text left right
                   if(k==6)shift10-=10;  if(k==7)shift10+=10;   // in out

                   if(k==0)shift12-=10;  if(k==1)shift12+=10;    //z text radially
                   if(k==2)shift11-=10;  if(k==3)shift11+=10; 
                    }
